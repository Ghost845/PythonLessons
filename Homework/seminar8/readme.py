...
def add_employe(first_name: str, last_name: str):
    ...
    # Реализовать создание сотрудника с его атрибутами (ФИО, номер телефона и т.д.)

def find_employers():
    return employees
    # Вывести список всех сотрудников (Возвращать словарь сотрудников)


def find_one_employe(id: int):
    # Обработать ошибку, если передали id несуществующего сотруднка
